...
<div class="px-0 py-0 sm:px-6 sm:pb-2">
    <article
        class="max-w-2xl bg-white shadow sm:rounded-2xl sm:rounded-tl-none sm:rounded-tr-none mx-auto px-6 py-6 sm:px-8 lg:px-8">
    ...
    <article
        class="my-2  max-w-2xl bg-white shadow sm:rounded-2xl  mx-auto px-6 py-6 sm:px-8 lg:px-8">
